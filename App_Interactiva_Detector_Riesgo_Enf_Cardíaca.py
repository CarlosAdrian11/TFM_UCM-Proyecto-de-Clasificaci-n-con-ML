...
st.markdown("<h1 style='text-align: center; color: #4682B4;'>TFM-UCM: Detector de Riesgo de Enfermedad Cardíaca</h1>", unsafe_allow_html=True)
...
cp = st.sidebar.selectbox("Tipo de dolor en el pecho", [1, 2, 3, 4], format_func=lambda x: ["1 = Angina típica", "2 = Angina atípica", "3 = Dolor no anginoso", "4 = Asintomático"][x])
